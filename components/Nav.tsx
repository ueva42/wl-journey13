    ...
    <header className="sticky top-0 z-50 border-b border-white/10 bg-[#05060a]/70 backdrop-blur">
      ...
      {open && (
        <div className="sm:hidden">
          ...
          {/* Drawer Panel */}
          <div className="fixed right-0 top-0 z-50 h-full w-[86%] max-w-sm border-l border-white/10 bg-[#05060a] p-4 shadow-2xl">
            {/* Top */}
            <div className="flex items-center justify-between">
              <div>
              ...
              <button
                onClick={() => setOpen(false)}
                className="rounded-xl border border-white/10 bg-white/5 px-3 py-2 text-sm hover:bg-white/10 text-zinc-100"
              >
                ✕
              </button>
            </div>
